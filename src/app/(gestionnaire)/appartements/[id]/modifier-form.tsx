          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="space-y-1">
              ...
              <select name="etage" defaultValue={appart.etage} className="w-full border rounded-md p-2 text-sm bg-card text-foreground">
                <option value="RDC">RDC</option><option value="PREMIER">1er</option><option value="DEUXIEME">2ème</option><option value="TROISIEME">3ème</option><option value="QUATRIEME">4ème</option><option value="CINQUIEME">5ème</option><option value="AUTRE">Autre</option>
              </select>
            </div>
            <div className="space-y-1">
