  ...
  return (
    <div className="space-y-6 animate-in">
      ...
      <div className="flex gap-1 flex-wrap">
        ...
        <Link href="/baux?statut=EXPIRE" className={`text-xs px-3 py-1.5 rounded-full border transition-colors ${statut === "EXPIRE" ? "bg-orange-500 text-white" : "text-muted-foreground hover:bg-muted"}`}>Expirés</Link>
      </div>
