        ...
        <div className="bg-white rounded-lg border overflow-hidden">
          <table className="w-full">
            <thead className="bg-gray-50 text-left text-sm text-gray-500">
              <tr><th className="p-3">Mois</th><th className="p-3">Montant</th><th className="p-3">Mode</th><th className="p-3">Date</th><th className="p-3">Statut</th><th className="p-3">Preuve</th></tr>
            </thead>
            <tbody className="divide-y">
              {paiements.map((p) => (
                <tr key={p.id}>
                  ...
                  <td className="p-3">{p.preuvePaiement ? <a href={p.preuvePaiement} target="_blank" className="text-blue-600 text-sm">📎 Voir</a> : "—"}</td>
                </tr>
              ))}
            </tbody>
          </table>
